...
void turn_of_bot_5x5 (int a[5][5]){
    ...
    // Ưu tiên đánh ô chính giữa
    if(a[2][2] == 0){
        int Random = rand() % 100 + 1;
        // 80% chọn a[2][2]
        if (Random > 20) {
            a[2][2] = 2;
            cout << "Uu tien a[2][2]" << endl;
            return;
        }
    }
            ...
            for (int i = 1; i < 4; i++){
                ...
                if (num1 == 4 && num2 > 0){
                    while(true){
                        ...
                        // 5 % a[i][0]; 40% a[i][1]; 15% a[i][2]; 40% a[i][3];
                        if (RandOption <= 5 && a[i][0] == 0) {
                            a[i][0] = 2;
                            cout << "V.1.a" << endl;
                            return;
                        }
                        else if (5 < RandOption && RandOption <= 45 && a[i][1] == 0){
                            a[i][1] = 2;
                            cout << "V.1.a" << endl;
                            return;
                        }
                        else if (45 < RandOption && RandOption <= 60 && a[i][2] == 0){
                            a[i][2] = 2;
                            cout << "V.1.a" << endl;
                            return;
                        }
                        else if (60 < RandOption && RandOption <= 100 && a[i][3] == 0){
                            a[i][3] = 2;
                            cout << "V.1.a" << endl;
                            return;
                        }
        ...
        if (RandOrder == 1){
            ...
            for (int i = 1; i < 4; i++){
                ...
                if (num1 == 4 && num2 > 0){
                    while(true){
                        int RandOption = rand() % 100 + 1;
                        // 5 % a[i][4]; 40% a[i][1]; 15% a[i][2]; 40% a[i][3];
                        if (RandOption <= 5 && a[i][4] == 0) {
                            a[i][4] = 2;
                            cout << "V.1.b" << endl;
                            return;
                        }
        ...
        if (RandOrder == 2){
            ...
            for (int j = 1; j < 4; j++){
                ...
                if (num1 == 4 && num2 > 0){
                    while(true){
                        int RandOption = rand() % 100 + 1;
                        // 5% a[0][j]; 40% a[1][j]; 15% a[2][j]; 40% a[3][j];
                        if (RandOption <= 5 && a[0][j] == 0) {
                            a[0][j] = 2;
                            cout << "V.2.a" << endl;
                            return;
                        }
                        else if (5 < RandOption && RandOption <= 45 && a[1][j] == 0){
                            a[1][j] = 2;
                            cout << "V.2.a" << endl;
                            return;
                        }
                        else if (45 < RandOption && RandOption <= 60 && a[2][j] == 0){
                            a[2][j] = 2;
                            cout << "V.2.a" << endl;
                            return;
                        }
                        else if (60 < RandOption && RandOption <= 100 && a[3][j] == 0){
                            a[3][j] = 2;
                            cout << "V.2.a" << endl;
                            return;
                        }
        ...
        if (RandOrder == 3){
            ...
            for (int j = 1; j < 4; j++){
                ...
                if (num1 == 4 && num2 > 0){
                    while(true){
                        int RandOption = rand() % 100 + 1;
                        // 5% a[4][j]; 40% a[1][j]; 15% a[2][j]; 40% a[3][j];
                        if (RandOption <= 5 && a[0][j] == 0) {
                            a[4][j] = 2;
                            cout << "V.2.b" << endl;
                            return;
